...
-- Achille ; mdpuser
INSERT INTO "stagify"."utilisateurs" ("pseudo", "mdp", "nom", "prenom", "date_naissance", "tel", "email", "date_inscription", "annee_academique", "est_admin", "nb_contacts", "etat_plus_avance", "num_version") VALUES ('achille', '$2a$10$AvfajQ3KJrIwtaRL893v6eVmNKqCTjpg1wKU8DiwsLnN5wUKW.Iz6', 'Legros', 'Achille', '1996-10-13 00:00:00', '+32498643411', 'achille.legros@student.vinci.be', '2015-03-01 15:45:05', '2014-2015', 'f', 0, 0, 1);
-- Basile ; mdpuser
INSERT INTO "stagify"."utilisateurs" ("pseudo", "mdp", "nom", "prenom", "date_naissance", "tel", "email", "date_inscription", "annee_academique", "est_admin", "nb_contacts", "etat_plus_avance", "num_version") VALUES ('basile', '$2a$10$AvfajQ3KJrIwtaRL893v6eVmNKqCTjpg1wKU8DiwsLnN5wUKW.Iz6', 'Lemaigre', 'Basile', '1995-10-12 00:00:00', '+32471613482', 'basile@student.vinci.be', '2016-03-01 16:00:00', '2015-2016', 'f', 0, 0, 1);
-- Caroline ; mdpuser
INSERT INTO "stagify"."utilisateurs" ("pseudo", "mdp", "nom", "prenom", "date_naissance", "tel", "email", "date_inscription", "annee_academique", "est_admin", "nb_contacts", "etat_plus_avance", "num_version") VALUES ('caro', '$2a$10$AvfajQ3KJrIwtaRL893v6eVmNKqCTjpg1wKU8DiwsLnN5wUKW.Iz6', 'Lalongue', 'Caroline', '1999-11-14 00:00:00', '+32495673104', 'Caro.lal@student.vinci.be', '2018-03-01 16:01:01', '2017-2018', 'f', 0, 0, 1);
-- student2016 ; mdpuser
INSERT INTO "stagify"."utilisateurs" ("pseudo", "mdp", "nom", "prenom", "date_naissance", "tel", "email", "date_inscription", "annee_academique", "est_admin", "nb_contacts", "etat_plus_avance", "num_version") VALUES ('theo', '$2a$10$AvfajQ3KJrIwtaRL893v6eVmNKqCTjpg1wKU8DiwsLnN5wUKW.Iz6', 'Legrand', 'Théophile', '1996-10-12 00:00:00', '+32495673104', 'theo.phile@student.vinci.be', '2018-03-01 16:01:01', '2017-2018', 'f', 0, 0, 1);
...
INSERT INTO "stagify"."entreprises" ("denomination", "adresse", "numero", "boite", "code_postal", "ville", "email", "tel", "est_black_liste","est_supprime", "num_version") VALUES ('Zepabu', 'Rue Gray', '21', NULL, '1050', 'Ixelles', 'contact@zebu.be', '+3223549565', 'f','f', 1);
INSERT INTO "stagify"."entreprises" ("denomination", "adresse", "numero", "boite", "code_postal", "ville", "email", "tel", "est_black_liste","est_supprime", "num_version") VALUES ('Xattrappe', 'Avenue de l''Eglise', '666', NULL, '1000', 'Bruxelles', 'contact@xattrapp.be', '+3223549462', 'f','f', 1);
INSERT INTO "stagify"."entreprises" ("denomination", "adresse", "numero", "boite", "code_postal", "ville", "email", "tel", "est_black_liste","est_supprime", "num_version") VALUES ('Xattrappeuh', 'Avenue de l''Eglise', '666', NULL, '1000', 'Bruxelles', 'contact@xattrapp.be', '+3223549462', 'f','f', 1);
INSERT INTO "stagify"."entreprises" ("denomination", "adresse", "numero", "boite", "code_postal", "ville", "email", "tel", "est_black_liste","est_supprime", "num_version") VALUES ('Drasil', 'Avenue de Mai', '103', NULL, '1200', 'Woluwé-Saint-Lambert', 'info@yggdrasil.be', '+3223546121', 'f','f', 1);


-- PERSONNES DE CONTACT
INSERT INTO "stagify"."personnes_contact" ("nom", "prenom", "tel", "email", "entreprise", "num_version") VALUES ('Colonel', 'Marguerite', '+32495683101', 'marguerite.fleur@xattrapp.be', 1, 1);
INSERT INTO "stagify"."personnes_contact" ("nom", "prenom", "tel", "email", "entreprise", "num_version") VALUES ('Général', 'Noémie', '+32497685214', 'noemie.janssens@xattrapp.be', 1, 1);
INSERT INTO "stagify"."personnes_contact" ("nom", "prenom", "tel", "email", "entreprise", "num_version") VALUES ('Caporal', 'Ortense', '+32498653410', 'ortense_cia@yggdrasil.be', 2, 1);
INSERT INTO "stagify"."personnes_contact" ("nom", "prenom", "tel", "email", "entreprise", "num_version") VALUES ('Fantassin', 'Zaiplussoif', '+32498653410', 'zf@yggdrasil.be', 3, 1);
